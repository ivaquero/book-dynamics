...
$ H_n = "sup" {pi(P, Q) : ∂P, ∂Q ≤ n} $

其中，$∂$表示次（degree），$pi(P, Q)$为系统的极限环数。

#theorem(ctext("Dulac 定理"))[
...
#theorem[
  ...
  其中，$P_n$和$Q_n$是$n$次齐次多项式，注意解是由$(θ_i, θ_i + pi)$给出的，只要$g_(n+1)(θ) ≠ 0$，就有$n+1$对根，当$g_(n+1)(θ) < 0$时，流向为顺时针，当$g_(n+1)(θ) > 0$时，流向为逆时针。
]
